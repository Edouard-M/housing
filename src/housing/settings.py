...
SECRET_KEY = 'django-insecure-7y4(9g--ntu2li_zaz@0ann5s)mvr2&3x%hujqiw78mt+*r%)s'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "housing/templates"), os.path.join(BASE_DIR, "search/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
